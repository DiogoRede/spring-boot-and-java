package br.com.diogorede.springcursoaws.exceptions.handler;
...
import br.com.diogorede.springcursoaws.exceptions.ExceptionResponse;
...
import br.com.diogorede.springcursoaws.exceptions.UnsupportedMathOperationException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public final ResponseEntity<ExceptionResponse> handlerBadRequestObjectExceptions(Exception ex, WebRequest request){
        ExceptionResponse exceptionResponse = 
            new ExceptionResponse(new Date(), ex.getMessage(), request.getDescription(false));
