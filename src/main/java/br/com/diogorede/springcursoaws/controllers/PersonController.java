...
public class PersonController {
    ...
    @PatchMapping("/{id}")
    @Operation(summary = "Disable a People by your id", description = "Disable a People by your id",
        tags = {"People"},
        responses = {
            @ApiResponse(description = "Success", responseCode = "200", 
                content = @Content(schema = @Schema(implementation = PersonVo.class))
    ...
    public PersonVo disable(@PathVariable(value = "id") Long id) throws Exception {
